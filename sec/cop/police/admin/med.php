        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content" style="background-color: #000;">
                ...
                <nav class="navbar navbar-expand bg-transparent topbar mb-4 static-top shadow border-primary">
                    ...
                    <h4 class="text-light" style="text-shadow: 0px 0px 10px green;">Medical Emergencies</h4>
                        ...
                        <div class="card-body" style="background-color: #00011a">
                            <div class="table-responsive">
                                <table class="table border-0" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <?php
                                    $query = "SELECT * FROM medical_emergency, p_user where medical_emergency.id_number = p_user.id_number ORDER BY medical_id DESC";
                                    ...
                                    if($result->num_rows>0){
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-warning"><?php echo $hostel; ?></td>
                                            <td class="text-light"><?php echo $feedback; ?></td>
                                            <td class="text-danger"><?php echo $location; ?></td>
                                            <td class="text-light"><?php echo $ambulance; ?></td>
                                            <td class="text-light">0<?php echo $phone; ?></td>
                                            <td class="text-info"><?php echo $date; ?></td>
                                        </tr><?php    }}?>
                                    </tbody>
                                </table>
                            </div>
