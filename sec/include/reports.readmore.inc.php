...
<div class="row">
    <?php
    require 'conn.php';
    $sql = "SELECT * FROM report  ORDER BY date DESC LIMIT 6;";
    ...
    foreach ($string as $k => &$v) {
        ...
        if ($result->num_rows > 0) {
            ...
            ?>
            <div class="col-md-4">
                <div class="card bg-transparent border-danger border-left-0 border-right-0" style="height:150px; border:1px-solid; border-radius: 21px:">
                    ...
                    <?php echo $title;?> @ <?php echo $location;?><br>
                        ...
                        <br><br>
                        <?php echo"<a href='readmore.process.inc.php?report_id=$report_id'  class='emg text-center btn' style='width:100%;'>View Report</a>"; ?>
                    </div>
                </div>
            </div>
    <?php  }
