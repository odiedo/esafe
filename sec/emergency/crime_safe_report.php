...
$sql = "SELECT * FROM report, p_user where report.id_number = $user order by date DESC LIMIT 1 ";
...
<br>
    <div class="card bg-transparent" style="box-shadow: 0px 3px 10px yellow;">
        ...
        <center>
            ...
            <span class="h5 text-light text-center">Crime Emergency Report</span><br></center>
...
var seventeenth='crime_emg.php';var eighteenth=10;var nineteenth=document.fifteenth.sixteenth.value=eighteenth+1;
function twentieth(){
